...
namespace CarBook.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminCategoryController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync("https://localhost:7127/api/Categories/?id=" + id);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7127/api/Categories/{id}");
