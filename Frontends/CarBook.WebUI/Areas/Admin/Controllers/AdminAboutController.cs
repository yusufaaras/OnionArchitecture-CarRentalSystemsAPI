...
namespace CarBook.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminAboutController : Controller
    {
        ...
        public async Task<IActionResult> CreateAbout(CreateAboutDto createAboutDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7127/api/Abouts", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync("https://localhost:7127/api/Abouts/?id=" + id);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7127/api/Abouts/{id}");
