...
namespace CarBook.WebUI.Controllers
{
    public class AdminBrandController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync("https://localhost:7127/api/Brands?id="+id);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7127/api/Brands/{id}");
